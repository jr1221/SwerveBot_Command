...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public static final int kDriveEncoderCPR = 1024;

    public static final int kTurningEncoderCPR = 7; // TODO CHANGED PPR of PG Hall is '7', no idea if this is right, default is 1024
